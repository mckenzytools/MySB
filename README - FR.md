...
* **Version actuelle** _(stable)_: **v5.1**
...
* Vous **devez** avoir un **noyau Debian standard**! Si vous ne pouvez pas installer un noyau **standard**, MySB **N**'est **PAS** pour vous... _(les **noyaux PVE** **ne** sont **pas** pris en charge)_
